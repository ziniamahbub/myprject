<div class="row">
            ...
            <table id="tblView" class="table table-striped table-bordered dt-responsive nowrap" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {!! Form::button('<i class="fa fa-edit"></i>',array('class'=>'btn btn-xs btn-warning btn-edit','id'=>'btn-edit','data-edit-id'=>$row['id'],'data-edit-url'=>'product_unit_edit')) !!}
                            <!--<button id="btn-edit" class="btn btn-xs btn-warning btn-edit" data-edit-id="{!! $row['id'] !!}" data-edit-url="product_unit_edit"><i class="fa fa-edit"></i></button>-->
    ...
    <div class="col-md-6" id="form_container" style="display:none;">
        {!! Form::open(['class'=>'form-horizontal','id'=>'form_product_unit']) !!}
        <div class="panel panel-default">
            <div class="panel-heading">
            	<h4 class="panel-title">{!! $page_title !!}</h4>
            </div><!-- panel-heading -->
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-sm-6">
                        {!! Form::label('txt_unit_name','Unit Name',array('class'=>'control-label') )!!}
                        {!! Form::text('txt_unit_name','',array('class'=>'form-control required_field','style'=>'width:100%;')) !!}
                    </div>
                    <div class="col-sm-6">
        	...
        	<div class="panel-footer">
                <div class="row">
                    <center>
                        ...
                        {!! Form::button('<i class="fa fa-check-circle"></i> <span id="btn_text">Save</span>',array('class'=>'btn btn-md btn-success btn-save','id'=>'btn-save','data-form-id'=>'form_product_unit','data-save-url'=>'product_unit_store','data-update-url'=>'product_unit_update')) !!}
                        {!! Form::button('<i class="fa fa-refresh"></i> Refresh',array('class'=>'btn btn-md btn-primary','type'=>'reset', 'id'=>'btn-refresh')) !!}
                        {!! Form::button('<i class="fa fa-times"></i> Cancel',array('class'=>'btn btn-md btn-danger btn-cancel','id'=>'btn-cancel','data-cancel-url'=>'product_unit_cancel')) !!}
                    </center> 
                </div><!-- row -->
            </div>
        </div><!-- panel -->
