<div class="row">
            ...
            <table id="tblView" class="table table-striped table-bordered dt-responsive nowrap" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {!! Form::button('<i class="fa fa-edit"></i>',array('class'=>'btn btn-xs btn-warning btn-edit','id'=>'btn-edit','data-edit-url'=>'supplier_edit','data-edit-id'=>$row['id'])) !!}
    ...
    <div class="col-md-6" id="form_container" style="display:none;">
        {!! Form::open(['class'=>'form-horizontal','id'=>'form_supplier']) !!}
        <div class="panel panel-default">
            <div class="panel-heading">
            	<h4 class="panel-title">{!! $page_title !!}</h4>
            </div><!-- panel-heading -->
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-sm-6">
                        {!! Form::label('txt_supplier_name','Supplier Name',array('class'=>'control-label') )!!}
                        {!! Form::text('txt_supplier_name','',array('class'=>'form-control required_field','style'=>'width:100%;')) !!}
                    </div>
                    <div class="col-sm-6">
                        {!! Form::label('txt_contact_person','Contact Person',array('class'=>'control-label') )!!}
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        ...
                        {!! Form::text('txt_mobile_no','',array('class'=>'form-control required_field','style'=>'width:100%;')) !!}
                    </div>
                    <div class="col-sm-6">
        	...
        	<div class="panel-footer">
                <div class="row">
                    <center>
						...
						{!! Form::button('<i class="fa fa-check-circle"></i> <span id="btn_text">Save</span>',array('class'=>'btn btn-md btn-success btn-save','id'=>'btn-save','data-form-id'=>'form_supplier','data-save-url'=>'supplier_store','data-update-url'=>'supplier_update')) !!}
                        {!! Form::button('<i class="fa fa-refresh"></i> Refresh',array('class'=>'btn btn-md btn-primary','type'=>'reset', 'id'=>'btn-refresh')) !!}
                        {!! Form::button('<i class="fa fa-times"></i> Cancel',array('class'=>'btn btn-md btn-danger btn-cancel','id'=>'btn-cancel','data-cancel-url'=>'supplier_cancel')) !!}                        
                    </center> 
                </div><!-- row -->
            </div>
        </div><!-- panel -->
